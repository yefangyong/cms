...
<ul>
    ...
    <li><a href="../templates/sidebarm.html" id="nav3" target="sidebar" onclick="admin_top_nav(3)">会员</a></li>
    <li><a href="###" id="nav4" target="sidebar" onclick="admin_top_nav(4)">系统</a></li>
</ul>
<p>您好 <strong><?php echo $this->_vars['admin_user'];?></strong> [ <?php echo $this->_vars['level_name'];?> ] [<a href="###">去首页</a> ] [ <a href="admin_login.php?action=logout" target="_parent">退出</a> ]</p>
</body>
</html>